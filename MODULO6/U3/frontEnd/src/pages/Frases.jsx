...
import "../Styles/pages/frases.css";

const Frases = () => {
  return (
    <div className="holder frases">

      <section>
        <h2 className="say2">
          <span data-aos="fade-down" data-aos-easing="linear" data-aos-duration="2000"> y la realidad </span>
      ...
      <section>
        <h2 className="say1">
          <span data-aos="fade-down" data-aos-easing="linear" data-aos-duration="2000">La distancia entre los sueños </span>
      ...
      <section>
        <h2 className="say3">
          <span data-aos="fade-up" data-aos-easing="linear" data-aos-duration="2000"  >se llama disciplina.</span>
